...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('bg-[var(--background)] group/calendar p-3 [--cell-size:2.5rem]', className)}
      ...
      classNames={{
        ...
        dropdown: cn('absolute bg-[var(--popover)] inset-0 opacity-0', defaultClassNames.dropdown),
        caption_label: cn(
          'select-none font-medium text-[var(--foreground)]',
          captionLayout === 'label'
            ? 'text-sm'
            : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-[var(--muted-foreground)] [&>svg]:size-3.5',
          defaultClassNames.caption_label
        ),
        table: 'w-full border-collapse',
        weekdays: cn('flex', defaultClassNames.weekdays),
        weekday: cn(
          'text-[var(--muted-foreground)] rounded-md flex-1 font-normal text-[0.8rem] select-none',
        ...
        week_number: cn(
          'text-[0.8rem] select-none text-[var(--muted-foreground)]',
        ...
        range_middle: cn('rounded-none bg-[var(--accent)]', defaultClassNames.range_middle),
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        group-data-[focused=true]/day:border-[var(--ring)]
        group-data-[focused=true]/day:ring-[var(--ring)]/50
        dark:hover:text-[var(--accent-foreground)]
        flex aspect-square w-full min-w-[var(--cell-size)] flex-col gap-1
